...
.event-class{border:5px solid #84f7fb;padding:20px 40px;border-radius:50px 0 50px 0;transform:translate(-8px,-8px);box-shadow:5px 5px 0 var(--background-color),9px 9px 0 lightblue,13px 13px 0 var(--background-color);}
