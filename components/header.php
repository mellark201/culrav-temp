...
<header>
  <div id="menu">
    <div class="menu-left"><!--<img id="image-logo" src="images/logo.png">--><a href="./" style="color:black;text-decoration:unset;"><h3><span class="text-stroke font-fam"  style="text-shadow: 3px 3px #2a2221,5px 5px lightblue,7px 7px black,9px 9px grey !important;-webkit-text-stroke: 2px #84f7fb;color:#2a2221;">CULRAV</span></h3></a></div>
  ...
  <div id="menu-options">
    <div class="flex" style="justify-content:center;align-items:center;margin:0;">
      ...
      <div id="quick-contact-info">
        <h3>Need Help?</h3>
        <br>
        <h5>Email at culrav2021@gmail.com</h5>
        <br>
        <h5>Or Contact any Festival Secretary from the Team page</h5>
        <!-- <a style="text-decoration:underline;line-height:200%;cursor:pointer;" onclick="javascript:invertColors()">Change Theme</a> -->
      </div>
    </div>
  </div>
  <div id="menu-footer">
      <div>&copy; Culrav 2021, MNNIT all rights reserved.</div>
