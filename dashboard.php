    ...
    <div class="flex">
        ...
        if($user['verified'] == 0){?>
            <div class="verification-box" style="margin-top:0">
                ...
                <p class="simple">You need to verify your account to be able to participate in Culrav 2021.<br/><br/>Please enter your &nbsp;<strong><u>registration number</u></strong>&nbsp; to verify.</p>
        ...
        ?>
            ...
            <div class="select-team-event-to-register">
                ...
                <p class="simple">Create a team of members and participate in the most enticing events of Culrav 2021. Make new connections and compete against other teams.</p>
